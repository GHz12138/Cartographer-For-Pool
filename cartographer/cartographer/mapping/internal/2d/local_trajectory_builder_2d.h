...
// 当范围数据积累完成时返回MatchingResult，否则返回nullptr。
// 对于2D SLAM，距离数据必须近似水平。
// TimedPointCloudData::time 是range_data 中最后一个点被获取的时间，
// TimedPointCloudData::ranges包含点相对于TimedPointCloudData::time的相对时间。
